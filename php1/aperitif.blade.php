...
<body>
  ...
  <script>
    ...
    var imageData = [
      { path: 'img/brochette italienne.jpg', name: 'brochette italienne' },
      { path: 'img/cake.jpg', name: 'cake' },
      { path: 'img/virene au saumo.jpg', name: 'virene au saumo' },
      { path: 'img/salade tiede.jpg', name: 'salade tiede' },
      { path: 'img/salade niçoise.jpg', name: 'salade niçoise' },
      { path: 'img/salade.jpg', name: 'salade' }
    ];
