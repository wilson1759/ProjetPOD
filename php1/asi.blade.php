...
<body>
  ...
  <script>
    ...
    var imageData = [
      { path: 'img/ceche.jpg', name: 'ceche' },
      { path: 'img/Au_Temps_Sushi_Plat_asiatique_B2.jpg', name: 'Sushi' },
      { path: 'img/ramelle.jpg', name: 'ramen' },
      { path: 'img/patte chinois.jpg', name: 'nouille' },
      { path: 'img/les joyaux de sherazade.jpg', name: 'les joyaux de sherazade' },
      { path: 'img/c1.jpg', name: 'dishes' }
    ];
