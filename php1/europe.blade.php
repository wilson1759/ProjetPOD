...
<body>
  ...
  <script>
    ...
    var imageData = [
      { path: 'img/tarte.jpg', name: 'tarte' },
      { path: 'img/poulet farci.jpg', name: 'poulet farci' },
      { path: 'img/poulet patate douce.jpg', name: 'poulet patate douce' },
      { path: 'img/Le_thieboudienne.jpg', name: 'Le_thieboudienne' },
      { path: 'img/tarte au concombre.jpg', name: 'tarte au concombre' },
      { path: 'img/soupe.jpg', name: 'soupe' }
    ];
