...
<body>
  ...
  <script>
    ...
    var imageData = [
      { path: 'img/puré.jpg', name: 'puré de pomme' },
      { path: 'img/c3.jpg', name: 'pizza' },
      { path: 'img/grillade.jpg', name: 'grillade' },
      { path: 'img/veau.jpg', name: 'veau' },
      { path: 'img/champignon.jpg', name: 'champignon' },
      { path: 'img/burger.jpg', name: 'burger' }
    ];
