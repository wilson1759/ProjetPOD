...
<body>
  ...
  <script>
    ...
    var imageData = [
      { path: 'img/pilé.jpg', name: 'pile' },
      { path: 'img/okok.jpg', name: 'okok' },
      { path: 'img/ndolé aux gambas.jpg', name: 'Ndole aux gambas' },
      { path: 'img/Taro.jpg', name: 'Taro' },
      { path: 'img/sanga.jpg', name: 'sanga' },
      { path: 'img/legume.jpg', name: 'legume' }
    ];
