...
<body>
  ...
  <script>
    ...
    var imageData = [
      { path: 'img/c2.jpg', name: 'duai' },
      { path: 'img/pilli.jpg', name: 'pilli' },
      { path: 'img/Croquemonsieur.jpg', name: 'Croquemonsieur' },
      { path: 'img/gauffre au chocolat.jpg', name: 'gauffre au chocolat' },
      { path: 'img/gauffre exhautique.jpg', name: 'gauffre exhautique' },
      { path: 'img/gauche.jpg', name: 'gauche' }
    ];
